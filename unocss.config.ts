...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gpt-subtitle': 'text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-rouge to-jaune',
    ...
    'gen-text-wrapper': 'my-4 fc gap-2 transition-opacity sticky bottom-0 filter backdrop-blur-sm p-4 m-0',
